# renderer-metal-adoption Specification

## Purpose

TBD - created by archiving change 'renderer-c2-metal-adoption'. Update Purpose after archive.
...
<!-- @trace
source: renderer-c2-metal-adoption
updated: 2026-05-30
code:
  - Sources/Logos/Terminal/MetalAdoptionPolicy.swift
  - Tests/LogosTests/SwiftTermViewMetalTests.swift
  - .spectra.yaml
  - docs/renderer-baselines/metal-adoption-interactive-validation.md
  - docs/design/2026-05-25-logos-design.md
  - CHANGELOG.md
  - docs/superpowers/plans/2026-05-26-renderer-rewrite-c2-frame-loop.md
  - Sources/Logos/Terminal/StreamTee.swift
-->
